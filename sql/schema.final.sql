...
declare
  updated jsonb;
  admin_id uuid := 'a1bd79f0-8a12-40e3-8ee5-d24427dddf71'; -- Carlos López
begin
  -- Solo el service_role o Carlos López pueden modificar montos
  if not (auth.role() = 'service_role' or auth.uid() = admin_id) then
...
grant execute on function public.set_order_amount(bigint, numeric, text)
...
drop view if exists orders_with_client cascade;
...
-- 🔹 1. Permitir que clientes sin login creen órdenes
